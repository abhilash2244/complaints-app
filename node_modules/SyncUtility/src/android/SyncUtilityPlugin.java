...
public class SyncUtilityPlugin extends CordovaPlugin {
  ...
  private void syncProjectForms(JSONArray args, CallbackContext callbackContext){
    /*Method responsible to sync form data in project task
    * */
    sendDataRequest(fetchData(parseInputData(args, 4),4), callbackContext);
  }
...
//    * */
  ...
  private Cursor fetchData(HashMap<String, Object> inParams, int type) {
    ...
    * */
    String taskKeys=null,formKeys=null,recordkeys=null,assignmentKeys=null;
    ...
    cordova.getThreadPool().execute(new Runnable() {
      ...
      public void run() {
        if(action.toLowerCase().equals("synctasks")){
          ...
          syncProjectForms(args,callbackContext);
        }
