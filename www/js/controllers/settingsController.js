...
*/
	...
	$scope.logout = function () {
		$localstorage.setObject("loggedIn", false);
		deviceManagement.logout($localstorage.getObject("username"),$localstorage.getObject("deviceInfo").manufacturer,$localstorage.getObject("deviceInfo").model,$localstorage.getObject("deviceInfo").platform,$localstorage.getObject("deviceInfo").uuid);
	};
