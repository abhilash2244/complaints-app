...
L.drawLocal = {
	verticeSize: L.Browser.touch ? 30 : 8,
	draw: {
		toolbar: {
			actions: {
...
L.Draw.Polyline = L.Draw.Feature.extend({
	...
	options: {
		...
		icon: new L.DivIcon({
			iconSize: new L.Point(L.drawLocal.verticeSize, L.drawLocal.verticeSize),
	...
	_onClick: function (e) {
		...
		//UBI CHANGE for measurement tool
		this._map.fire('draw:click', { poly: this._poly });
