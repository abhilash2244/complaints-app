...
.controller('LoginCtrl', function ($scope, $rootScope, $state, $timeout, ionicMaterialInk, $ionicHistory, $cordovaNetwork,
 loginService, config, $localstorage, alertService, commonService, $cordovaSQLite, $cordovaDevice, strings,setGetObj,
 deviceManagement,$ionicPopup) {
